...
x = np.array(d['image']).reshape((-1,3,101,101))
...
# model.load('/Users/Chris/CMUDeepLens/Trained_Sets/'+str(imgs)+'imgs_120epochs_RGB/deeplens_params_final.npy', x, y)
model.load('/Users/Chris/CMUDeepLens/deeplens_params_final.npy', x, y)
